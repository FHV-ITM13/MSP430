...
package/cfg/main_pe430.se430: package/cfg/main_pe430.c package/cfg/main_pe430.mak
	...
	$(RM) $@
	@$(MSG) cle430 -n $< ...
	$(ti.targets.msp430.elf.MSP430.rootDir)/bin/cl430 --abi=eabi -c -n -s --symdebug:none --symdebug:dwarf --optimize_with_debug -qq -pdsw225  -vmsp -eo.oe430 -ea.se430   -Dxdc_cfg__header__='xconfig_main/package/cfg/main_pe430.h'  -Dxdc_target_name__=MSP430 -Dxdc_target_types__=ti/targets/msp430/elf/std.h -Dxdc_bld__profile_release -Dxdc_bld__vers_1_0_4_2_1 -O2 -g --optimize_with_debug  $(XDCINCS) -I$(ti.targets.msp430.elf.MSP430.rootDir)/include  -fs=./package/cfg -fr=./package/cfg -fc $<
	$(MKDEP) -a $@.dep -p package/cfg -s oe430 $< -C  -n -s --symdebug:none --symdebug:dwarf --optimize_with_debug -qq -pdsw225  -vmsp -eo.oe430 -ea.se430   -Dxdc_cfg__header__='xconfig_main/package/cfg/main_pe430.h'  -Dxdc_target_name__=MSP430 -Dxdc_target_types__=ti/targets/msp430/elf/std.h -Dxdc_bld__profile_release -Dxdc_bld__vers_1_0_4_2_1 -O2 -g --optimize_with_debug  $(XDCINCS) -I$(ti.targets.msp430.elf.MSP430.rootDir)/include  -fs=./package/cfg -fr=./package/cfg
	-@$(FIXDEP) $@.dep $@.dep
